...
namespace Resturant.Infrastructure.Migrations
{
    ...
    [Migration("20260702165804_AddHomeDeliveryModule")]
    partial class AddHomeDeliveryModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Resturant.Core.Entities.DeliveryAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.DeliveryZone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ArabicGovernorate")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.Driver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.DriverSettlement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.InventoryCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.InventoryCountItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.InventoryMovement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("StockAfter")
                        .HasColumnType("float");

                    b.Property<double>("StockBefore")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("BranchId", "MovementDate");

                    b.HasIndex("IngredientId", "MovementDate");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.MenuItemPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MenuItemId", "PriceType", "BranchId", "IsActive");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.Order", b =>
                {
                    ...
                    b.HasIndex("ShiftId", "BranchId", "Status");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.PurchaseOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.PurchaseOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Resturant.Core.Entities.Driver", b =>
                {
                    ...
                    b.HasOne("Resturant.Core.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("Resturant.Core.Entities.DriverSettlement", b =>
                {
                    b.HasOne("Resturant.Core.Entities.Driver", "Driver")
                        .WithMany()
                    ...
                    b.HasOne("Resturant.Core.Entities.ApplicationUser", "SettledBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Resturant.Core.Entities.InventoryCountItem", b =>
                {
                    ...
                    b.HasOne("Resturant.Core.Entities.InventoryCount", "InventoryCount")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Resturant.Core.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Resturant.Core.Entities.DeliveryAddress", "DeliveryAddress")
                        .WithMany()
                        .HasForeignKey("DeliveryAddressId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Resturant.Core.Entities.DeliveryZone", "DeliveryZone")
                        .WithMany()
            ...
            modelBuilder.Entity("Resturant.Core.Entities.PurchaseOrderItem", b =>
                {
                    ...
                    b.HasOne("Resturant.Core.Entities.PurchaseOrder", "PurchaseOrder")
                        .WithMany("Items")
